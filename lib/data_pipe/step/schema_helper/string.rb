...
module DataPipe::Step::SchemaHelper
  class String < FieldSchema
    ...
    def apply(value, field, record)
      ...
      raise DataPipe::Error::ValidationError.new(record, "Field [#{field}] required!") if params.required? && ret_value.empty?
      ...
      return ret_value.titlecase if params.titlecase? && !ret_value.empty?
